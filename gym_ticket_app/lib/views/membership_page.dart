...
class _MembershipPageState extends State<MembershipPage> {
  ...
  Widget build(BuildContext context) {
    // Usamos MediaQuery para obtener el ancho y alto de la pantalla
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: screenHeight * 0.02), // Ajuste responsivo de la altura
  ...
  void _showTiqueteraDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        // Usamos MediaQuery para ajustar el ancho y alto del diálogo
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: dialogWidth, // Ajuste responsivo del calendario
                  child: TableCalendar(
...
class MembershipOption extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Usamos MediaQuery para ajustar el tamaño de los contenedores
    double screenWidth = MediaQuery.of(context).size.width;
    double screenHeight = MediaQuery.of(context).size.height;

    return Container(
      padding: EdgeInsets.all(screenWidth * 0.03), // Ajuste responsivo del padding
